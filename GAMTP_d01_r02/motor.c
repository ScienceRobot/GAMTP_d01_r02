...
//TIMER_0 uses the TC0 peripheral which takes as input a 400Khz generic clock was: 400MHz generic clock 
//which creates an tick (interrupt) every 25us- a 40khz (25us) signal for Motor pwm
