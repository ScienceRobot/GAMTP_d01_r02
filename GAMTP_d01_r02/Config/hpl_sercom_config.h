...
#define CONF_SERCOM_1_USART_RXPO 1 /* RX is on PIN_PC28 */
#endif

#ifndef CONF_SERCOM_1_USART_TXPO
#define CONF_SERCOM_1_USART_TXPO 0 /* TX is on PIN_PC27 */
#endif
...
#define CONF_SERCOM_3_I2CM_BAUD 400000//100000
#endif
...
#define CONF_SERCOM_6_USART_BAUD 115200
#endif
...
// <i> How many over-sampling bits used when sampling data state
// <id> usart_arch_sampr
#ifndef CONF_SERCOM_6_USART_SAMPR
...
// <i> Adjust which samples to use for data sampling in asynchronous mode
// <id> usart_arch_sampa
#ifndef CONF_SERCOM_6_USART_SAMPA
...
// <i> Fractional part of the baud rate if baud rate generator is in fractional mode
// <id> usart_arch_fractional
#ifndef CONF_SERCOM_6_USART_FRACTIONAL
...
// <1=>IrDA encoded
// <id> usart_arch_enc
#ifndef CONF_SERCOM_6_USART_ENC
...
// <1=>Enable
// <id> usart_arch_lin_slave_enable
#ifndef CONF_SERCOM_6_USART_LIN_SLAVE_ENABLE
#define CONF_SERCOM_6_USART_LIN_SLAVE_ENABLE 0
#endif
...
#define CONF_SERCOM_6_USART_CMODE 0
#endif

#ifndef CONF_SERCOM_6_USART_RXPO
#define CONF_SERCOM_6_USART_RXPO 1 /* RX is on PIN_PC17 */
#endif

#ifndef CONF_SERCOM_6_USART_TXPO
#define CONF_SERCOM_6_USART_TXPO 0 /* TX is on PIN_PC16 */
#endif

/* Set correct parity settings in register interface based on PARITY setting */
#if CONF_SERCOM_6_USART_LIN_SLAVE_ENABLE == 1
#if CONF_SERCOM_6_USART_PARITY == 0
#define CONF_SERCOM_6_USART_PMODE 0
#define CONF_SERCOM_6_USART_FORM 4
#else
#define CONF_SERCOM_6_USART_PMODE CONF_SERCOM_6_USART_PARITY - 1
#define CONF_SERCOM_6_USART_FORM 5
#endif
#else /* #if CONF_SERCOM_6_USART_LIN_SLAVE_ENABLE == 0 */
#if CONF_SERCOM_6_USART_PARITY == 0
#define CONF_SERCOM_6_USART_PMODE 0
#define CONF_SERCOM_6_USART_FORM 0
#else
#define CONF_SERCOM_6_USART_PMODE CONF_SERCOM_6_USART_PARITY - 1
#define CONF_SERCOM_6_USART_FORM 1
#endif
#endif
